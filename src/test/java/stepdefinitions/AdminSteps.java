...
public class AdminSteps {
	...
	@Quando("^informa o campo de busca User Role como \"([^\"]*)\"$")
	public void informa_o_campo_de_busca_User_Role_como(String arg1) throws Throwable {
		AdminPage ap = new AdminPage(Hooks.getDriver());
		ap.preencherPerfilBusca(arg1);
	}

	@Quando("^informa o campo de busca Employee Name como \"([^\"]*)\"$")
	public void informa_o_campo_de_busca_Employee_Name_como(String arg1) throws Throwable {
		AdminPage ap = new AdminPage(Hooks.getDriver());
		ap.preencherNomeFuncionarioBusca(arg1);
	}

	@Quando("^informa o campo de busca Status como \"([^\"]*)\"$")
	public void informa_o_campo_de_busca_Status_como(String arg1) throws Throwable {
		AdminPage ap = new AdminPage(Hooks.getDriver());
